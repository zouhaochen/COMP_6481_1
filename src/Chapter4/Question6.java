 ...
 * any grade of 70 or more (but less than 80) is a C, any grade of 60 or more (but less than 70) is a D,
 * and any grade below 60 is an F.
 * The program should read in the student’s scores and output the student’s record,
 ...
 * The class should have instance variables for the quizzes, midterm, final,
 * overall numeric score for the course, and final letter grade.
 * The overall numeric score is a number in the range 0 to 100,
 * which represents the weighted average of the student’s work.
 * The class should have methods to compute the overall numeric grade and the final letter grade.
 * These last methods should be void methods that set the appropriate instance variables.
 * Your class should have a reasonable set of accessor and mutator methods, an equal method,
 * and a toString method, whether or not your program uses them. You may add other methods if you wish.
 * */
class StudentRecord
{
    // Instance variables
